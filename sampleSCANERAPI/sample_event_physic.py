...
Com_registerEvent('Network/IPhysics/InfraPosition', -1)
Com_registerEvent('Network/IPhysics/Collision', -1)
    ...
    while status != PS_DEAD:
        ...
        while event:
            ...
            if evtType == ET_message:
                ...
                if 'Network/IPhysics/InfraPosition' in msg_name:
                    print_infra_position(data_interface_path)
                if msg_name == 'Network/IPhysics/Collision':
                    print 'collision'
                    print_collision(data_interface_path)
                event = Com_getNextEvent()
